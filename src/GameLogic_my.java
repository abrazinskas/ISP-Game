//
//public class GameLogic_my implements IGameLogic {
//    private int cols;
//    private int rows;
...
//                int value = minMove(board, depth+1, alpha, beta);
//                if(value>alpha){
//                    alpha = value;
//                    result = i;
//                }
...
//            if(columnIsFull(board,i)!= true){
//                insertCoin(i,playerID);
//                int value = maxMove(board, depth+1, alpha, beta);
//                //TODO include beta
//                if(value<beta){
//                    beta = value;
//                }
